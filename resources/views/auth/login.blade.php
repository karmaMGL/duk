...
<body class="bg-gray-100">
    ...
    <div class="min-h-screen py-6 flex flex-col justify-center sm:py-12">
        <div class="relative py-3 sm:max-w-xl sm:mx-auto">
            <div
                class="absolute inset-0 bg-gradient-to-r from-blue-400 to-cyan-500 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
            </div>
                    ...
                    <form method="POST" action="{{ route('auth.login') }}" class="mt-8 space-y-6">
                        ...
                        <div class="space-y-4">
                            <div class="relative">
                                ...
                                <label for="email"
                                    class="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-blue-600 peer-focus:text-sm">
                                    Email Address
                                </label>
                                @error('email')
                            ...
                            <input type="hidden" value="" id="userIp" name="userIp">
                            <div class="relative">
