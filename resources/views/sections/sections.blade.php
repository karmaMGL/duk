  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      @foreach ($sections as $section)
        @php
          ...
          $scoreColor = $section['averageScore'] >= 80 ? 'text-green-600' : ($section['averageScore'] >= 60 ? 'text-yellow-600' : 'text-red-600');
    ...
    <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
      <a href="{{ url('/exams/dynamic') }}">
        <button class="w-full sm:w-auto px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 flex items-center justify-center">
          <i data-lucide="clock" class="w-4 h-4 mr-2"></i>
          Take Practice Exam
        </button>
      </a>
      <a href="{{ url('/road-signs') }}">
        <button class="w-full sm:w-auto px-6 py-3 border border-gray-300 bg-white text-gray-700 rounded-md hover:bg-gray-50 flex items-center justify-center">
