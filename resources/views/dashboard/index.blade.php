            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <h2 class="text-xl font-bold text-gray-900">Your Study Plans</h2>
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <x-dashboard.study-plan-card 
                            ...
                            description="Complete all road sign practice tests"
                            :progress="75"
                            :totalSections="8"
                            :completedSections="6"
                            dueDate="2025-07-10"
                        ...
                        <x-dashboard.study-plan-card 
                            ...
                            description="Practice identifying hazards in video clips"
                            :progress="40"
                            :totalSections="5"
                            :completedSections="2"
                            dueDate="2025-07-20"
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Track your overall progress and achievements</p>
                    </div>
                    <div class="card-body">
                        <div class="mb-6">
            ...
            <div class="space-y-6">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Helpful tips for your test preparation</p>
                    </div>
                    <div class="p-4">
                        <div class="space-y-4">
