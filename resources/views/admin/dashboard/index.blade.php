      ...
      <div class="lg:col-span-2 space-y-8">
        ...
        <div class="bg-white shadow rounded-lg">
          ...
          <div class="p-6 grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="/admin/questions/new" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
            ...
            <a href="/admin/users" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
            ...
            <a href="/admin/reports" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
            ...
            <a href="/admin/settings" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
      ...
      <div class="space-y-6">
        ...
        <div class="bg-white shadow rounded-lg">
          ...
          <div class="p-6 space-y-3">
            <a href="/admin/users" class="block w-full px-4 py-2 text-left text-sm bg-gray-100 rounded hover:bg-gray-200"><i data-lucide="users" class="w-4 h-4 inline mr-2"></i>User Management</a>
            <a href="/admin/questions" class="block w-full px-4 py-2 text-left text-sm bg-gray-100 rounded hover:bg-gray-200"><i data-lucide="book-open" class="w-4 h-4 inline mr-2"></i>Question Bank</a>
            <a href="/admin/exams" class="block w-full px-4 py-2 text-left text-sm bg-gray-100 rounded hover:bg-gray-200"><i data-lucide="trophy" class="w-4 h-4 inline mr-2"></i>Exam Management</a>
            <a href="/admin/payments" class="block w-full px-4 py-2 text-left text-sm bg-gray-100 rounded hover:bg-gray-200"><i data-lucide="dollar-sign" class="w-4 h-4 inline mr-2"></i>Payments</a>
          </div>
        </div>
